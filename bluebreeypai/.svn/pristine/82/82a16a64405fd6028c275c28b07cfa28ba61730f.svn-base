	...
	var methods = {
		...
		imageWidget: function(){
			...
			var getURL = $("<button/>",{
				...
				type:"button"
			}).html("点击导入").click(function(){
				var url = $('#imageURL').val();
				if(url ==''){
					methods.showMessage.apply(this,["imgErrMsg","请输入图片链接地址"]);
					return false;
				}
					...
					id:"tblForm"+idExtn
						...
						class:"row"
							...
							class:"col-xs-12 col-sm-6 col-md-6 col-lg-6"
								...
								)).append($('<option/>',{ text:"Left", value:"左"}
								)).append($('<option/>',{ text:"Center", value:"中"}
								)).append($('<option/>',{ text:"Right",	value:"右"}))
						).append($('<label/>',{	for:"tblBorder"+idExtn, text:"线条粗细"}
							)).append($('<input/>',{
								id:"tblBorder"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellspacing"+idExtn,	text:"单元格空隙"}
							)).append($('<input/>',{
								id:"tblCellspacing"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellpadding"+idExtn,	text:"单元格内边距"}
							)).append($('<input/>',{
		...
		init : function( options )
		{
			...
			var colors = [	{ name: 'Black', hex: '#000' },
				{ name: 'MediumBlack', hex: '#444' },
				{ name: 'LightBlack', hex: '#666' },
				{ name: 'DimBlack', hex: '#999' },
				{ name: 'Gray', hex: '#CCC' },
				{ name: 'DimGray', hex: '#EEE' },
			...
			var menuItems = {
				...
				'color'	: { "text":"A",
					"icon": "fa fa-font iconfont  icon-iconzitiyanse",
				...
				'bold'	: { "text": "B",
					"icon": "fa fa-bold iconfont icon-jiacu",
					"tooltip": "Bold",
					"commandname":"bold",
					"custom":null },

				'italics'	: { "text":"I",
					"icon":"fa fa-italic iconfont icon-xieti",
					"tooltip":"Italics",
					"commandname":"italic",
					"custom":null },

				'underline': { "text":"U",
					"icon":"fa fa-underline iconfont icon-xiahuaxian",
					"tooltip":"Underline",
					"commandname":"underline",
					"custom":null },

				'strikeout': { "text": "Strikeout",
					"icon":"fa fa-strikethrough iconfont icon-shanchuxian",
					"tooltip": "Strike Through",
					"commandname":"strikeThrough",
					"custom":null },

				'ol'		: { "text": "N",
					"icon": "fa fa-list-ol iconfont icon-numlist",
					"tooltip": "Insert/Remove Numbered List",
					"commandname":"insertorderedlist",
					"custom":null },

				'ul'		: { "text": "Bullet",
					"icon": "fa fa-list-ul iconfont icon-liebiao",
					"tooltip": "Insert/Remove Bulleted List",
					"commandname":"insertunorderedlist",
					"custom":null },

				'undo'		: { "text": "undo",
					"icon": "fa fa-undo iconfont icon-iconhuifu",
					"tooltip": "Undo",
					"commandname":"undo",
					"custom":null },

				'redo'		: { "text": "redo",
					"icon": "fa fa-repeat iconfont icon-huifu",
					"tooltip": "Redo",
					"commandname":"redo",
					"custom":null },

				'l_align'	: { "text": "leftalign",
					"icon": "fa fa-align-left iconfont icon-juzuo",
					"tooltip": "Align Left",
					"commandname":"justifyleft",
					"custom":null },

				'r_align'	: { "text": "rightalign",
					"icon": "fa fa-align-right iconfont icon-juyou",
					"tooltip": "Align Right",
					"commandname":"justifyright",
					"custom":null },

				'c_align'	: { "text": "centeralign",
					"icon": "fa fa-align-center iconfont icon-juzhongduiqi  ",
					"tooltip": "Align Center",
					"commandname":"justifycenter",
					"custom":null },

				'justify'	: { "text": "justify",
					"icon": "fa fa-align-justify iconfont icon-hengpai",
					"tooltip": "Justify",
					"commandname":"justifyfull",
					"custom":null },

				'unlink'	: { "text": "Unlink",
					"icon": "fa fa-unlink iconfont icon-unlink",
					"tooltip": "Unlink",
					"commandname":"unlink",
					"custom":null },
				...
				'insert_link': { "modal": true,
					"modalId": "InsertLink",
					"icon":"fa fa-link iconfont icon-lianjie",
					"tooltip": "Insert Link",
					"modalHeader": "插入超链接",
					...
					"onSave":function(){
						...
						if(targetURL ==''){
							methods.showMessage.apply(editorObj,["errMsg","请输入链接地址"]);
							return false;
						}
				...
				'insert_img'	: {
					"modal": true,
					"modalId": "InsertImage",
					"icon":"fa fa-picture-o iconfont icon-tupian",
					...
					"onSave": function(){
						...
						if($('#imageList').data('current')){
							...
							methods.showMessage.apply(this,["imgErrMsg","您未选择任何图片!"]);
							return false;
						}
				...
				'insert_table'	: { "modal": true,
					"modalId": "InsertTable",
					"icon":"fa fa-table iconfont icon-biaoge",
				...
				'hr_line'	: { "text": "HR",
					"icon":"fa fa-minus iconfont icon-line",
					"tooltip": "Horizontal Rule",
					"commandname":"insertHorizontalRule",
					"custom":null },

				'block_quote': { "text": "Block Quote",
					"icon":"fa fa-quote-right iconfont icon-quot",
					"tooltip": "Block Quote",
					"commandname":null,
					"custom":function(){
						methods.setStyleWithCSS.apply(this);
				...
				'indent'		: { "text": "Indent",
					"icon":"fa fa-indent iconfont icon-suojin",
					"tooltip": "Increase Indent",
					"commandname":"indent",
					"custom":null },

				'outdent'	: { "text": "Outdent",
					"icon":"fa fa-outdent iconfont icon-quxiaosuojin",
					"tooltip": "Decrease Indent",
					"commandname":"outdent",
					"custom":null },

				'print'		: { "text": "Print",
					"icon":"fa fa-print iconfont icon-dayin",
					"tooltip": "Print",
					"commandname":null,
					"custom":function(){
				...
				'rm_format'	: { "text": "Remove format",
					"icon":"fa fa-eraser iconfont icon-xiangpica",
					"tooltip": "Remove Formatting",
					"commandname":"removeformat",
					"custom":null },

				'select_all': { "text": "Select all",
					"icon":"fa fa-file-text iconfont icon-quanxuan",
					"tooltip": "Select All",
					"commandname":null,
					"custom":function(){
				...
				'togglescreen':{ "text": "Toggle Screen",
					"icon": "fa fa-arrows-alt iconfont icon-quanping",
				...
				'splchars'	: { "text": "S",
					"icon": "fa fa-asterisk iconfont icon-xinghao2",
				...
				'source'	: { "text": "Source",
					"icon":"fa fa-code iconfont icon-daima",
					"tooltip": "Source",
					"commandname":null,
			...
			if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label" style="display:none">'+'Words : '+wordCount+'</div>');
		...
		createTableContext: function(event,cMenuUl){
			...
			cMenuUl.append($('<li/>',{class:"dropdown-submenu",css:{display:"block"}})
				...
				.append($('<ul/>',{class:"dropdown-menu"})
					...
					.append($('<li/>').append($('<a/>',{text:"删除行"}).click(
						function(e) { return function(){
							$('#context-menu').remove();
				...
				.append($('<ul/>',{class:"dropdown-menu"})
					...
					.append($('<li/>').append($('<a/>',{text:"删除列"}).click(
						function(e) { return function(){
							$('#context-menu').remove();
			...
			cMenuUl.append($('<li/>').append(modalTrigger))
				...
				.append($('<li/>').append($('<a/>',{text:"移除表格"}).click(
					function(e){ return function(){
						$('#context-menu').remove();
					...
					class:"modal-dialog"
						...
						class:"modal-content"
							...
							class:"modal-footer"
								...
								type:"button",
								class:"btn btn-success",
							}).html('我已选好').mousedown(function(e){
								e.preventDefault();
